...
const DiscoveryTabs = () => {
    ...
    const categories = {
        'Beach Vacations': [
            { name: 'Maldives', img: '/maldives-custom.jpg' },
        ...
        'Stay Like Royals': [
            ...
            { name: 'Dubai', img: '/dubai-custom.png' },
    ...
    return (
        <div style={{ background: 'white', padding: '2rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', position: 'relative', zIndex: 10 }}>
